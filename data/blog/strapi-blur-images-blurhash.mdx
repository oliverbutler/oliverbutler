...
draft: false
summary: 'Do you like waiting for images to load? Me neither - Today were going to look at how to implement BlurHash in Strapi.'
authors: ['default']
thumbnail: '/static/images/strapi-blurhash/thumbnail.jpeg'
---
...
![blurhash](/static/images/strapi-blurhash/blurhash-hlf.png)

<Gif url="https://media.giphy.com/media/zIwIWQx12YNEI/source.gif" caption="No no. BlurHash. 🪄" />
