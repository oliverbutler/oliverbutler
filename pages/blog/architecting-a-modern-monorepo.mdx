...
import nxInstall from "public/architecting-a-modern-monorepo/nx-install.png";
import nxCreateReactLib from "public/architecting-a-modern-monorepo/nx-create-react-lib.png";
import nxCreateReactLibUseComponent from "public/architecting-a-modern-monorepo/nx-create-react-lib-use-component.png";
import nxDepGraph from "public/architecting-a-modern-monorepo/nx-dep-graph.png";
import nxAffected1 from "public/architecting-a-modern-monorepo/nx-affected-1.png";
import nxAffected1Graph from "public/architecting-a-modern-monorepo/nx-affected-1-graph.png";
import nxAffected2 from "public/architecting-a-modern-monorepo/nx-affected-2.png";
import nxAffected2Graph from "public/architecting-a-modern-monorepo/nx-affected-2-graph.png";

import turboStructure from "public/architecting-a-modern-monorepo/turbo-structure.png";
...
If you want to learn some more Turborepo, I strongly reccomend you take a look at the [Turborepo Docs](https://turborepo.org/docs).

### Ideal for 💡

- Vercel users, Remote Caching works great
- Small to medium projects
- You don't mind loosing some features of NX
...
### Create an a Next.js NX project
...
The NX CLI will then prompt you for what template to use to create this new application, for our case let's choose "Next.js".
...
One benefitial usage of NX is to create a shared library, which can be used by multiple apps. Shared libs are found in the `libs` directory.

```bash
nx g @nrwl/react:lib ui-shared
```

Running this command generates a new "ui-shared" library, which can be used by multiple apps, the beauty of this pattern is changes to your "ui-shared
will rebuild other apps that use it, where as, if you make a change in "next-app" NX wont rebuild "ui-shared"

<Image
  src={nxCreateReactLib}
  placeholder="blur"
  className="mt-10 mx-auto"
  layout="responsive"
  style={{ width: "100%" }}
...
Here you can see importing our new shared library, and using it in our Next.js app.

<Image
  src={nxCreateReactLibUseComponent}
  placeholder="blur"
  className="mt-10 mx-auto"
  layout="responsive"
  style={{ width: "100%" }}
  alt="NX Use Component"
/>
...
To handle this NX has the `affected` command, for example `nx affected --target=next-app` will figure out which tasks to run, and only run those tasks.

To visualize this use the `nx affected:graph` command, in this example below we've added a `second-shared` lib which is also used in `next-app`
...
<Image
  ...
  layout="responsive"
  style={{ width: "100%" }}
  alt="NX Affected Files"
/>

<Image
  src={nxAffected1Graph}
  placeholder="blur"
  className="mt-10 mx-auto"
  layout="responsive"
  style={{ width: "100%" }}
...
<Image
  ...
  layout="responsive"
  style={{ width: "100%" }}
  alt="NX Affected Files 2"
/>

<Image
  src={nxAffected2Graph}
  placeholder="blur"
  className="mt-10 mx-auto"
  layout="responsive"
  style={{ width: "100%" }}
  alt="NX Affected Graph 2"
/>
...
If you want to learn some more NX, I strongly reccomend you take a look at the [NX Documentation](https://nx.dev/docs/).
...
- [NX and Turborepo comparison](https://nx.dev/guides/turbo-and-nx?utm_source=twitter&utm_medium=ads&utm_campaign=dec2021) (From NX)
