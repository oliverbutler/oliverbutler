...
import thumbnail from "public/strapi-blurhash.jpg";
import blurhashHlf from "public/blurhash-hlf.png";
...
<Image src={blurhashHlf} placeholder="blur" />
