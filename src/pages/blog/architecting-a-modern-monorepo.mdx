...
![nx-install](/images/architecting-a-modern-monorepo/nx-install.png)
...
![nx-create-react-lib](/images/architecting-a-modern-monorepo/nx-create-react-lib.png)

Here you can see the process of importing our new shared library, and using it in our Next.js app.

![nx-create-react-lib-use-component](/images/architecting-a-modern-monorepo/nx-create-react-lib-use-component.png)
...
![nx-affected-1](/images/architecting-a-modern-monorepo/nx-affected-1.png)

![nx-affected-1-graph](/images/architecting-a-modern-monorepo/nx-affected-1-graph.png)
...
![nx-affected-2](/images/architecting-a-modern-monorepo/nx-affected-2.png)

![nx-affected-2-graph](/images/architecting-a-modern-monorepo/nx-affected-2-graph.png)
...
![nx-incremental-builds](/images/architecting-a-modern-monorepo/nx-incremental.png)
...
![turbo-structure](/images/architecting-a-modern-monorepo/turbo-structure.png)
